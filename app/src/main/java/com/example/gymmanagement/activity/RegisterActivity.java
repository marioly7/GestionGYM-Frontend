...
public class RegisterActivity extends AppCompatActivity{
    ...
    private static final String[] types = {"Administrador", "Encargado", "Cliente"};
    private static final String[] plans = {"Administrador", "Encargado", "Cliente"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enc = findViewById(R.id.radioCli);
        ...
        registerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!(etPassword.getText().toString()).equals(etConfirmPassword.getText().toString())){
                    ...
                    return;
                }else if (admi.isChecked() && userRegisteringId!=1) {
                    Toast.makeText(getApplicationContext(), "Debe ser un administrador para registrar a un tipo de usuario administrador", Toast.LENGTH_SHORT).show();
                    return;
                }else {
